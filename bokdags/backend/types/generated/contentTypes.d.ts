...
export interface ApiSavedBookSavedBook extends Struct.CollectionTypeSchema {
  collectionName: 'saved_books';
  info: {
    displayName: 'saved-book';
...
export interface ApiThemeTheme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::theme.theme'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.Enumeration<['light', 'dark', 'ocean']>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    savedByUsers: Schema.Attribute.Relation<'manyToOne', 'api::book.book'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
